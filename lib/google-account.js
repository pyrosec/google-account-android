...
class GoogleAccountAndroid {
    ...
    static async createAccount({ username, password, name, pin, smspinverify }) {
        ...
        await exports.py.call(googleAccount.googleAccountViewClient, "goto_add_google", pin || "000000");
        googleAccount.logger.info('wait 10s');
        await (0, exports.timeout)(10000);
